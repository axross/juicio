      ...
      <View style={[styles.root, style]} testID={testID} pointerEvents="box-none" {...props}>
        {
          ...
          // fall back to nothing on its own below Android API 31. stays on
          // `isRendering` rather than joining `isBackdropRendering` below:
          // that gate ends a *touch* life, and this layer carries none —
          // its own `pointerEvents="none"` already keeps it out of every
          // hit test, so ending it earlier would buy nothing the gate is
          // for.
        }
