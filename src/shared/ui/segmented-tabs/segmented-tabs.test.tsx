...
// synchronous test tick — the label-reveal tests below read
// `useAnimatedStyle`'s own output directly (`width`/`opacity`), which the
// real implementation updates out of band from React's own render rather
// than returning synchronously — `react-native-reanimated/mock`'s
// versions collapse straight to the target value instead, the same reason
