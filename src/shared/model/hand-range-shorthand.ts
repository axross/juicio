...
export type HandRangeShorthand = {
   ...
   * can hand it straight to the Rust parser once hand ranges are wired to
 ...
 * tested apart from the UI, the same way every other rule in `shared/model/`
 * is: if **any** of `shorthand.rankPairs` isn't yet in `selected`, the press
