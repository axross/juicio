import { AnalyzeScreen } from '@/features/evaluations/ui/analyze-screen/analyze-screen';

/**
 * the Analyze tab's route entry point: a thin composition of
 * `AnalyzeScreen` and nothing else. The screen's own body, styles, and
 * doc comment live at `src/features/evaluations/ui/analyze-screen/analyze-screen.tsx` —
