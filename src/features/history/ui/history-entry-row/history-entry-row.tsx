 ...
 * own long-press-to-drag reorder gesture.
 *
 ...
 * neither of which this row has: no tap-to-open detail, no equity result
 * to show.
 *
 * **no accessibility `'edit'` action, unlike a player row.** tapping this
 * row does nothing, so there is no edit outcome for a screen-reader user
 * to reach either — only `'delete'`, mirroring the player row's own
 * non-gesture deletion path.
 */
