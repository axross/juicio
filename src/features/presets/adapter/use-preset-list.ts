 ...
 * this app can create or edit a Preset yet (the Preset editor is still a
 * field-less stub), so there is no later moment this screen's own result
 * could go stale while it stays mounted.
 *
 ...
 * either; the only way back to a loaded list is leaving and returning to
 * the Presets tab, which remounts this hook.
 */
