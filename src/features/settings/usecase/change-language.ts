 ...
 * `Language` user property (issue #211) — a language names itself the same
 * way regardless of which language is currently active
 ...
 * property (issue #211) rather than a one-off event.
 */
