...
// Element" rules are real for `SettingsRow`'s own root `Pressable`, not
// merely type-level.
describe('<SettingsRow /> rest props and style', () => {
  it('merges a caller-supplied style onto its own root style rather than replacing it', () => {
    ...
    // ...alongside this row's own chrome, which a caller replacing rather
