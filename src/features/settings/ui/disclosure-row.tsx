 ...
 * `Language` and `Theme` rows are its two uses.
 *
...
> & {
  ...
  return (
    // rest props (position, onPress, style) spread last, the default
    // ordering per docs/conventions/component-contracts.md; `testID` is
    // consumed instead, since the value `Text` below needs it for its own
    // local testID.
    <SettingsRow
