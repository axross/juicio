...
| How a `uses:` reference under `.github/workflows/` is pinned, or the exposure that pinning defends against | [docs/conventions/security.md](./docs/conventions/security.md) |
