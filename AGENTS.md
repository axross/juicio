...
| A native module's Rust crates, their native-library build, the NDK version, or the 16 KB page-alignment requirement | [docs/operations/native-library-build.md](./docs/operations/native-library-build.md) |
